...
public class Main {
    public static void main(String[] args) {
        ...
        Team team1 = new Team("T1", "Team 1");
        team1.addPlayer(team1Players);
        Team team2 = new Team("T2", "Team 2");
        team2.addPlayer(team2Players);
        ...
        InfoService cricinfoSystem = new InfoService();
        ...
        System.out.println("Match: " + updatedScorecard.getMatch().getMatchName());
            ...
            for (Over over : innings.getOvers()) {
                ...
                for (Ball ball : over.getBalls()) {
                    System.out.println("Ball " + ball.getBallNumber() + ": " +
                            ball.getBowlerId() + " to " + ball.getBatsmanId() + " - " + ball.getRun());
                }
            }
            System.out.println();
        }
